import { PageMap, PageSuggestion, SanitizedElement, ServerAction } from "../schemas";

export function generatePageSuggestions(pageMap: PageMap | null | undefined): PageSuggestion[] {
